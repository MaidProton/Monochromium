export interface SaveBundle {
  ...
  readonly creatorFolders: unknown;
}
...
export const saveDiskSection = async (section: "meta" | "custom-modes" | "custom-enemies" | "custom-maps" | "creator-folders", value: unknown): Promise<boolean> => {
  if (desktopApi) {
    try {
